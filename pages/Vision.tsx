...
const Vision: React.FC = () => {
  ...
  return (
    <div ref={containerRef} className="pt-24 md:pt-48 pb-24 md:pb-40 px-4 md:px-6 overflow-hidden bg-dark-bg">
      <div className="max-w-[1600px] mx-auto relative z-10">
        ...
        {/* Increased card visibility and filled space with 4th card */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 mb-24 md:mb-40">
          {cards.map((item, i) => (
            <div key={i} className="vision-item bg-[#1A1A1A] p-8 md:p-10 rounded-[2rem] border border-white/10 hover:border-accent-green transition-all duration-500 group relative overflow-hidden shadow-2xl flex flex-col h-full">
              <div className="relative z-10">
                <div className="w-14 h-14 md:w-16 md:h-16 rounded-2xl bg-white/10 flex items-center justify-center mb-8 group-hover:bg-accent-green transition-colors duration-500">
                ...
                <p className="text-white/80 leading-relaxed font-medium transition-colors text-sm md:text-base">{item.desc}</p>
              </div>
        ...
        {/* Beyond Performance Section with high-impact image and mobile fixes */}
        <section className="vision-item rounded-[2rem] md:rounded-[4rem] overflow-hidden relative min-h-[500px] md:min-h-[700px] flex items-center p-8 md:p-24 shadow-2xl border border-white/10 group">
          <div className="absolute inset-0">
            <img 
              src="https://images.unsplash.com/photo-1518005020480-10992897c1e0?auto=format&fit=crop&q=80&w=2000" 
              alt="Ascension" 
              className="w-full h-full object-cover grayscale opacity-40 group-hover:grayscale-0 group-hover:scale-105 transition-all duration-[3s]" 
            />
          ...
          <div className="relative z-10 max-w-2xl">
            <div className="flex items-center gap-4 mb-8 md:mb-10">
              <div className="h-[1.5px] w-8 md:w-12 bg-white/60"></div>
              <span className="text-white/80 text-[10px] md:text-[11px] uppercase font-black tracking-[0.4em]">Our Mission</span>
            </div>
            
            <h2 className="text-4xl sm:text-6xl md:text-8xl font-display font-black mb-6 md:mb-10 uppercase italic tracking-tighter leading-[0.85] text-white">
              Beyond <br/>
              Performance.
            </h2>
            
            <p className="text-base md:text-lg text-white/80 leading-relaxed mb-10 md:mb-16 font-medium max-w-lg">
            ...
            <div className="flex flex-wrap gap-8 md:gap-24">
              <div>
                <p className="text-4xl md:text-7xl font-display font-black text-white tracking-tighter">98%</p>
                <p className="text-[10px] text-white/60 uppercase tracking-[0.3em] font-black mt-2 md:mt-4">Retention Rate</p>
              </div>
              <div>
                <p className="text-4xl md:text-7xl font-display font-black text-white tracking-tighter">10x</p>
                <p className="text-[10px] text-white/60 uppercase tracking-[0.3em] font-black mt-2 md:mt-4">ROI Reported</p>
              </div>
            </div>
          </div>
        </section>
